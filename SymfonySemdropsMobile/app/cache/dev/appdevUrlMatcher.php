...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // addCategoryphp
        if ($pathinfo === '/add_categoryphp') {
            return array (  '_controller' => 'Semdrops\\SemdropsMobileBundle\\Controller\\SemdropsController::addCategoryphpAction',  '_route' => 'addCategoryphp',);
        }
