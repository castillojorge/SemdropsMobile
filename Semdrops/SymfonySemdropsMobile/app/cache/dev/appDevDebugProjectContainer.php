...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $c = new \Assetic\Cache\ConfigCache('/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/assetic/config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'WebProfilerBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/Resources/WebProfilerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'WebProfilerBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'WebProfilerBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/Resources/WebProfilerBundle/views', '/^[^.]+\\.[^.]+\\.php$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'WebProfilerBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.php$/'))), 'php');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'SensioDistributionBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/Resources/SensioDistributionBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'SensioDistributionBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/vendor/bundles/Sensio/Bundle/DistributionBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'SensioDistributionBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/Resources/SensioDistributionBundle/views', '/^[^.]+\\.[^.]+\\.php$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'SensioDistributionBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/vendor/bundles/Sensio/Bundle/DistributionBundle/Resources/views', '/^[^.]+\\.[^.]+\\.php$/'))), 'php');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'SensioGeneratorBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/Resources/SensioGeneratorBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'SensioGeneratorBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/vendor/bundles/Sensio/Bundle/GeneratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'SensioGeneratorBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/Resources/SensioGeneratorBundle/views', '/^[^.]+\\.[^.]+\\.php$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'SensioGeneratorBundle', '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/vendor/bundles/Sensio/Bundle/GeneratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.php$/'))), 'php');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->setProxyDir('/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/config/routing_dev.yml', array('cache_dir' => '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app');
    }
    ...
    protected function getSwiftmailer_TransportService()
    {
        ...
        $instance->setUsername('semdropsmobile8@gmail.com');
        $instance->setPassword('symfonysemdropsmobile');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev',
            ...
            'debug.container.dump' => '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'profiler.storage.dsn' => 'sqlite:/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/profiler.db',
            ...
            'router.resource' => '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'swiftmailer.transport.smtp.username' => 'semdropsmobile8@gmail.com',
            'swiftmailer.transport.smtp.password' => 'symfonysemdropsmobile',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/var/www/RepositorioSemdropsMobile/Semdrops/SymfonySemdropsMobile/app/cache/dev/assetic',
